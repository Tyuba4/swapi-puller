...
class Vehicles extends ResourcePuller
{
    protected $relatedModelClass = Vehicle::class;
    ...
    protected function oldhandleOneCollection($collection)
    {
        ...
        $this->attachEntitiesFromString($collection->manufacturer, ',', 'manufacturers');
        ...
        $this->model->vehicle_class = $collection->vehicle_class;
