...
<form method="post" action="/films/create">
    ...
    <div>
        ...
        <input type="text" name="title" id="title-input" placeholder="string">
    </div>
    <div>
        <label for="episode_id-input"><b>Episode</b></label>
        <input type="text" name="episode_id" id="episode_id-input" placeholder="integer">
    </div>
    <div>
        <label for="opening_crawl-input"><b>Opening Crawl</b></label>
        <input type="text" name="opening_crawl" id="opening_crawl-input" placeholder="text">
    </div>
    <div>
        <label for="director-input"><b>Director</b></label>
        <input type="text" name="director" id="director-input" placeholder="string">
    </div>
    <div>
        <label for="release_date-input"><b>Release Date</b></label>
        <input type="text" name="release_date" id="release_date-input" placeholder="timestamp">
    </div>
    <div>
